package com.team3646.frc2019.planners;
...
import com.team3646.lib.physics.DCMotorTransmission;
import com.team3646.lib.physics.DifferentialDrive;
import com.team3646.lib.trajectory.*;
import com.team3646.lib.trajectory.timing.DifferentialDriveDynamicsConstraint;
import com.team3646.lib.trajectory.timing.TimedState;
import com.team3646.lib.trajectory.timing.TimingConstraint;
import com.team3646.lib.trajectory.timing.TimingUtil;
import com.team3646.lib.util.CSVWritable;
import com.team3646.lib.util.Units;
...
public class DriveMotionPlanner implements CSVWritable {
    ...
    public static final double kMaxDy = 0.25;
    ...
    public DriveMotionPlanner() {
        ...
        final DCMotorTransmission transmission = new DCMotorTransmission(
            ...
            Units.inches_to_meters(Constants.kDriveWheelRadiusInches) * Units.inches_to_meters(
                Constants.kDriveWheelRadiusInches) * Constants.kRobotLinearInertia / (2.0 * Constants.kDriveKa),
