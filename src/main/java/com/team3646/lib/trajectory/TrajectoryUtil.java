...
import com.team3646.lib.geometry.*;
import com.team3646.lib.spline.QuinticHermiteSpline;
import com.team3646.lib.spline.Spline;
import com.team3646.lib.spline.SplineGenerator;
        ...
        while (!path_follower.isDone()) {
            ...
            if (dcurvature < dcurvature_limit && curvature_valid) {
                steering_command = new Twist2d(steering_command.dx, steering_command.dy,
                                            (dcurvature_limit * steering_command.norm() + 
                                            current_state.getCurvature()) * steering_command.norm());
            }
