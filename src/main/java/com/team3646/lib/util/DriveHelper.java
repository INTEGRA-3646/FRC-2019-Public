...
public class DriveHelper {
    ...
    private static final double kHighNegInertiaScalar = 4;

    private static final double kLowNegInertiaThreshold = 0.65;
    private static final double kLowNegInertiaTurnScalar = 3.5;
    private static final double kLowNegInertiaCloseScalar = 4;
    private static final double kLowNegInertiaFarScalar = 5;
    ...
    private static final double kQuickStopScalar = 5;
