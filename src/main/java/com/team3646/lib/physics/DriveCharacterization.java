package com.team3646.lib.physics;

import com.team3646.lib.util.PolynomialRegression;
...
public class DriveCharacterization {
    ...
    private static CharacterizationConstants getAccelerationCharacterization(double[][] points, CharacterizationConstants velocityCharacterization) {
        if (points == null) {
