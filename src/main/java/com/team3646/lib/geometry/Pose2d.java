...
public class Pose2d implements IPose2d<Pose2d> {
    ...
    /**
     * Tarnsforming this rigid transform means first translating ad then rotating.
     */
    @Override 
    ...
    /**
     * Finds the point where the heading of this pose intersects the heading of another.
     */
    ...
    /**
     * Do twsit interpolation of this pose assuming constant curve.
     */
    @Override
