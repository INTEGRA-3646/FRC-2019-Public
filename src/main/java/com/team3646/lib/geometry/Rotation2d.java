...
import static com.team3646.lib.util.Util.kEpsilon;

/**
 * A rotation in a 2d coordinate frame represented a point on a unit circle.
 */
public class Rotation2d implements IRotation2d<Rotation2d> {
    ...
    public Rotation2d(double x, double y, boolean normalize) {
        if (normalize) {
        // Normalizing forces us to re-scale sine and cosine to reset rounding errors.
    ...
    public Rotation2d normal() {
        return new Rotation2d(-sin_angle_, cos_angle_, true);
    }

    public Rotation2d inverse() {
        return new Rotation2d(cos_angle_, -sin_angle_, true);
    }
